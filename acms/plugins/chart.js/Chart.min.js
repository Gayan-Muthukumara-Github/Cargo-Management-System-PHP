<?php
// Placeholder to ensure Chart.js path resolves; project already includes chart.js in plugins/chart.js per workspace
// If Chart.js is not present, you should place Chart.min.js here or update the script src in analytics page.
?>
